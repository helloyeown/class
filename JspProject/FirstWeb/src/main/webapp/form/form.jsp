...
<h1>Form Test</h1>
	<form action="<%=request.getContextPath() %>/form/input.jsp" method="post">
		...
		<br> 성별 : <input type="radio" name="gender" value="male">남성
		...
		<input type="checkbox" name="lang" value="jsp">jsp <input
			type="checkbox" name="lang" value="sql">sql <input
			type="checkbox" name="lang" value="html">html <br> 태어난
		년도 : <select name="birthyear">
